<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryInfo.aspx.cs" Inherits="ImanHusseinPizza.DeliveryInfo" %>
...
<body>
    ...
    <form id="formlLogin" runat="server" class="form_forizontal col-sm-offset-3 col-sm-6" >
        ...
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Delivery_ID" DataSourceID="SqlDataSourceDeliver" ForeColor="#333333" GridLines="None">
        ...
        <asp:SqlDataSource ID="SqlDataSourceDeliver" runat="server" ConnectionString="<%$ ConnectionStrings:pizzaDBSummer2017 %>" SelectCommand="SELECT * FROM [Delivery_Address] WHERE ([UserName] = @UserName)">
            <SelectParameters>
