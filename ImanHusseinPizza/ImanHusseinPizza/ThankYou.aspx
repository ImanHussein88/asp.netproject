<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThankYou.aspx.cs" Inherits="ImanHusseinPizza.ThankYou" %>
...
<body>
    ...
    <form id="formlLogin" runat="server" class="form_forizontal col-sm-offset-3 col-sm-6" >
     ...
     <asp:SqlDataSource ID="SqlDataSourceShoppingCart2" runat="server" ConnectionString="<%$ ConnectionStrings:pizzaDBSummer2017 %>" SelectCommand="SELECT * FROM [Order] WHERE ([UserName] = @UserName)">
            <SelectParameters>
                <asp:SessionParameter Name="UserName" SessionField="user" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:GridView ID="GridViewShoppingCart2" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderID" DataSourceID="SqlDataSourceShoppingCart2" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <asp:Button ID="ButtonConform" runat="server" Text="Confirm" class=" btn btn-primary btn-lg" PostBackUrl="~/Home.aspx" />
    </form>
        </div>
